...
INODE_SIZE=128
INODE_COUNT=$(($(inode_usage "$PRANAOS_SOURCE_DIR/sysroot") + $(inode_usage Root)))
DISK_SIZE_BYTES=$((($(disk_usage "$PRANAOS_SOURCE_DIR/sysroot") + $(disk_usage Root) + INODE_COUNT) * 1024))
