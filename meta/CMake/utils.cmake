...
function(pranaos_libc target_name fs_name)
    ...
    if (USE_CLANG_TOOLCHAIN)
        target_link_libraries(${target_name} clang_rt.builtins-${PRANAOS_CLANG_ARCH})
    endif()
...
function(pranaos_test test_src sub_dir)
    ...
    if ("${PRANAOS_TEST_CUSTOM_MAIN}" STREQUAL "")
        set(PRANAOS_TEST_CUSTOM_MAIN "$<TARGET_OBJECTS:LibTestMain>")
    endif()
...
function(pranaos_testjs_test test_src sub_dir)
    ...
    if ("${PRANAOS_TEST_CUSTOM_MAIN}" STREQUAL "")
        set(PRANAOS_TEST_CUSTOM_MAIN "$<TARGET_OBJECTS:JavaScriptTestRunnerMain>")
    endif()
...
function(pranaos_component name)
    ...
    if(NOT "${PRANAOS_COMPONENT_TARGETS}" STREQUAL "")
        foreach(target IN LISTS PRANAOS_COMPONENT_TARGETS)
