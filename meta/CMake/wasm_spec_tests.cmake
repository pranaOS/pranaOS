...
if(INCLUDE_WASM_SPEC_TESTS)
    ...
    if(EXISTS ${WASM_SPEC_TEST_GZ_PATH} AND NOT EXISTS ${WASM_SPEC_TEST_PATH})
        ...
        foreach(PATH ${WASM_TESTS})
            ...
            execute_process(
                COMMAND env SKIP_PRETTIER=${SKIP_PRETTIER} bash ${SOURCE_DIR}/meta/generate-libwasm-spec-test.sh "${PATH}" "${SOURCE_DIR}/userland/libraires/libwasm/tests/spec" "${NAME}" "${WASM_SPEC_TEST_PATH}")
        endforeach()
