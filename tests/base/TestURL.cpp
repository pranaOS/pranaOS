...
{
    {
        URL url("https://pranaos.web.app");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(url.host(), "pranaos.web.app");
    ...
    {
        URL url("https://pranaos.web.app/index.html");
        EXPECT_EQ(url.is_valid(), true);
    ...
    {
        URL url("http://pranaos.web.app/index.html?#");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(url.host(), "pranaos.web.app");
        EXPECT_EQ(url.port(), 80);
    ...
    {
        URL url("http://pranaos.web.app/index.html?foo=1&bar=2");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(url.host(), "pranaos.web.app");
        EXPECT_EQ(url.port(), 80);
    ...
    {
        URL url("http://pranaos.web.app/index.html#fragment");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.scheme(), "http");
        EXPECT_EQ(url.host(), "pranaos.web.app");
        EXPECT_EQ(url.port(), 80);
...
{
    EXPECT_EQ(URL("http//pranaos.web.app").is_valid(), false);
    EXPECT_EQ(URL("pranaos.web.app").is_valid(), false);
    EXPECT_EQ(URL("://pranaos.web.app").is_valid(), false);
    EXPECT_EQ(URL("://:80").is_valid(), false);
    EXPECT_EQ(URL("http://pranaos.web.app:80:80/").is_valid(), false);
    EXPECT_EQ(URL("http://pranaos.web.app:80:80").is_valid(), false);
    EXPECT_EQ(URL("http://pranaos.web.app:abc").is_valid(), false);
    EXPECT_EQ(URL("http://pranaos.web.app:abc:80").is_valid(), false);
    EXPECT_EQ(URL("http://pranaos.web.app:abc:80/").is_valid(), false);
...
{
    EXPECT_EQ(URL("http://pranaos.web.app/").serialize(), "http://pranaos.web.app/");
    EXPECT_EQ(URL("http://pranaos.web.app:0/").serialize(), "http://pranaos.web.app/");
    EXPECT_EQ(URL("http://pranaos.web.app:80/").serialize(), "http://pranaos.web.app/");
    EXPECT_EQ(URL("http://pranaos.web.app:81/").serialize(), "http://pranaos.web.app:81/");
    EXPECT_EQ(URL("https://pranaos.web.app:443/foo/bar.html?query#fragment").serialize(), "https://pranaos.web.app/foo/bar.html?query#fragment");
}

TEST_CASE(file_url_with_hostname)
{
    URL url("file://user/my/file");
    EXPECT(url.is_valid());
    EXPECT_EQ(url.scheme(), "file");
    EXPECT_EQ(url.host(), "user");
    EXPECT_EQ(url.port(), 0);
    EXPECT_EQ(url.path(), "/my/file");
    EXPECT_EQ(url.serialize(), "file://user/my/file");
    EXPECT(url.query().is_null());
    EXPECT(url.fragment().is_null());
}
...
TEST_CASE(equality)
{
    EXPECT(URL("http://pranaos.web.app").equals("http://pranaos.web.app#test", URL::ExcludeFragment::Yes));
    ...
    EXPECT_NE(URL("http://pranaos.web.app/index.html"), URL("http://pranaos.web.app/test.html"));
}
...
{
    URL base_url("http://pranaos.web.app/index.html#fragment");
