...
#include <EP/Format.h>
#include <EP/NumericLimits.h>
#include <EP/StdLibExtraDetails.h>
...
using u128 = EP::UFixedBigInt<u64>;
using u256 = EP::UFixedBigInt<u128>;
using u512 = EP::UFixedBigInt<u256>;
using u1024 = EP::UFixedBigInt<u512>;
using u2048 = EP::UFixedBigInt<u1024>;
using u4096 = EP::UFixedBigInt<u2048>;
