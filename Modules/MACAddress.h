...
public:
    ...
    static Optional<MACAddress> from_string(const StringView& string)
    {
        ...
        auto a = EP::StringUtils::convert_to_uint_from_hex(parts[0]).value_or(256);
        auto b = EP::StringUtils::convert_to_uint_from_hex(parts[1]).value_or(256);
        auto c = EP::StringUtils::convert_to_uint_from_hex(parts[2]).value_or(256);
        auto d = EP::StringUtils::convert_to_uint_from_hex(parts[3]).value_or(256);
        auto e = EP::StringUtils::convert_to_uint_from_hex(parts[4]).value_or(256);
        auto f = EP::StringUtils::convert_to_uint_from_hex(parts[5]).value_or(256);
