...
using EP::is_ascii;
using EP::is_ascii_alpha;
using EP::is_ascii_alphanumeric;
using EP::is_ascii_blank;
using EP::is_ascii_c0_control;
using EP::is_ascii_control;
using EP::is_ascii_digit;
using EP::is_ascii_graphical;
using EP::is_ascii_hex_digit;
using EP::is_ascii_lower_alpha;
using EP::is_ascii_printable;
using EP::is_ascii_punctuation;
using EP::is_ascii_space;
using EP::is_ascii_upper_alpha;
using EP::is_unicode;
using EP::is_unicode_control;
using EP::is_unicode_noncharacter;
using EP::is_unicode_scalar_value;
using EP::is_unicode_surrogate;
using EP::parse_ascii_base36_digit;
using EP::parse_ascii_digit;
using EP::parse_ascii_hex_digit;
using EP::to_ascii_base36_digit;
using EP::to_ascii_lowercase;
using EP::to_ascii_uppercase;
