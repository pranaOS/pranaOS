...
namespace Mods
{
    ...
    public:
        ...
        { 
            return !m_next_byte.has_value() && m_stream.unreliable_eof(); 
        }
        ...
        { 
            return static_cast<bool>(read_bits_big_endian(1)); 
        }
    ...
    public:
        /**
         * @brief Construct a new Output Bit Stream object
         * 
         * @param stream 
         */
        ...
        void write_bits(u32 bits, size_t count)
        {
            ...
            if (count == 32 && !m_next_byte.has_value()) { 
                m_stream << bits;
                return;
            }
