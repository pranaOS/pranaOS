    ...
    namespace Detail
    {
        ...
        public:
            ...
            Trie(ValueType value, Optional<MetadataType> metadata)
                : m_value(move(value)), m_metadata(move(metadata))
            {
            }
             ...
             * @param it 
             * @param end 
             * @return BaseType const& 
             */
            template <typename It>
            BaseType const& traverse_until_last_accessible_node(It& it, It const& end) const
            {
            ...
            /**
             * @tparam It 
             * @tparam ProvideMetadataFunction 
             */
            ...
            /**
             * @return HashMap<ValueType, NonnullOwnPtr<Trie>, ValueTraits>& 
             */
            HashMap<ValueType, NonnullOwnPtr<Trie>, ValueTraits>& children()
            {
                return m_children;
            }

            /**
             * @return HashMap<ValueType, NonnullOwnPtr<Trie>, ValueTraits> const& 
             */
            HashMap<ValueType, NonnullOwnPtr<Trie>, ValueTraits> const& children() const
            {
                return m_children;
            }
        ...
        private:
            /**
             * @param metadata 
             * @return ErrorOr<Optional<MetadataType>> 
             */
