...
namespace Mods
{
    namespace Detail
    {
        ...
        public:
            ...
            ALWAYS_INLINE Span(void* values, size_t size)
                : m_values(reinterpret_cast<u8*>(values)), m_size(size)
            {
            }
        ...
        public:
            ...
            ALWAYS_INLINE Span(void const* values, size_t size)
                : m_values(reinterpret_cast<u8 const*>(values)), m_size(size)
            {
            }
    ...
    public:
         ...
         * @return ALWAYS_INLINE constexpr 
         */
        [[nodiscard]] ALWAYS_INLINE constexpr size_t size() const
        {
            return this->m_size;
        }
