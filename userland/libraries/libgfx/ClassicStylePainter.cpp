...
void ClassicStylePainter::paint_radio_button(Painter& painter, const IntRect& rect, const Palette&, bool is_checked, bool is_being_pressed)
{
    if (!s_unfilled_circle_bitmap) {
        s_unfilled_circle_bitmap = Bitmap::try_load_from_file("/res/icons/pranaos/unfilled-radio-circle.png");
        s_filled_circle_bitmap = Bitmap::try_load_from_file("/res/icons/pranaos/filled-radio-circle.png");
        s_changing_filled_circle_bitmap = Bitmap::try_load_from_file("/res/icons/pranaos/changing-filled-radio-circle.png");
        s_changing_unfilled_circle_bitmap = Bitmap::try_load_from_file("/res/icons/pranaos/changing-unfilled-radio-circle.png");
    }
