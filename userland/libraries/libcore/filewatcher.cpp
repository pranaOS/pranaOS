...
namespace Core 
{
    ...
    /**
     * @brief Get the event from fd object
     * 
     * @param fd 
     * @param wd_to_path 
     * @return Optional<FileWatcherEvent> 
     */
    ...
    /**
     * @brief Construct a new BlockingFileWatcher::BlockingFileWatcher object
     * 
     * @param flags 
     */
    ...
    /**
     * @brief Destroy the BlockingFileWatcher::BlockingFileWatcher object
     * 
     */
    ...
    /**
     * @brief Construct a new FileWatcher::FileWatcher object
     * 
     * @param watcher_fd 
     * @param notifier 
     */
    ...
    /**
     * @brief Destroy the FileWatcher::FileWatcher object
     * 
     */
