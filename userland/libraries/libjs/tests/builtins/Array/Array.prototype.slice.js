...
test("basic functionality", () => {
    var array = ["hello", "friends", "pranaOS", 1];

    var slice = array.slice();
    expect(array).toEqual(["hello", "friends", "pranaOS", 1]);
    expect(slice).toEqual(["hello", "friends", "pranaOS", 1]);

    slice = array.slice(1);
    expect(array).toEqual(["hello", "friends", "pranaOS", 1]);
    expect(slice).toEqual(["friends", "pranaOS", 1]);
    ...
    slice = array.slice(1, -1);
    expect(array).toEqual(["hello", "friends", "pranaOS", 1]);
    expect(slice).toEqual(["friends", "pranaOS"]);

    slice = array.slice(2, -1);
    expect(array).toEqual(["hello", "friends", "pranaOS", 1]);
    expect(slice).toEqual(["pranaOS"]);
