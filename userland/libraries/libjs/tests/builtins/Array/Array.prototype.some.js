...
test("basic functionality", () => {
    var array = ["hello", "friends", 1, 2, false, -42, { name: "pranaos" }];

    expect(array.some(value => value === "hello")).toBeTrue();
    expect(array.some(value => value === "pranaOS")).toBeFalse();
    ...
    expect(["", "hello", "friends", "pranaOS"].some(value => value.length === 0)).toBeTrue();
