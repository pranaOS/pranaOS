...
namespace X86 
{
    ...
    protected:
        /**
         * @brief Destroy the Symbol Provider object
         * 
         */
    ...
    public:
        /**
         * @brief Construct a new Logical Address object
         * 
         */
         ...
         * @return FlatPtr 
         */
        FlatPtr offset() const 
        { 
            return m_offset; 
        }

        /**
         * @brief Set the selector object
         * 
         * @param selector 
         */
        void set_selector(u16 selector) 
        { 
            m_selector = selector; 
        }
         ...
         * @param offset 
         */
        void set_offset(FlatPtr offset) 
        { 
            m_offset = offset; 
        }
    ...
    protected:
        /**
         * @brief Destroy the Instruction Stream object
         * 
         */
    ...
    public:
        /**
         * @brief Construct a new Simple Instruction Stream object
         * 
         * @param data 
         * @param size 
         */
    ...
    public:
        ...
        { 
            return m_register_index != 0x7f; 
        }

        unsigned register_index() const 
        { 
            return m_register_index; 
        }

        RegisterIndex32 reg32() const 
        { 
            return static_cast<RegisterIndex32>(register_index()); 
        }

        RegisterIndex16 reg16() const 
        { 
            return static_cast<RegisterIndex16>(register_index()); 
        }
        ...
        FpuRegisterIndex reg_fpu() const 
        { 
            return static_cast<FpuRegisterIndex>(register_index()); 
        }
        ...
        u8 reg() const 
        { 
            return m_rm_byte >> 3 & 0b111; 
        }

        u8 rm() const 
        { 
            return m_rm_byte & 0b111; 
        }
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType8 
         */
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType16 
         */
        template<typename CPU>
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType32 
         */
        template<typename CPU>
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType64 
         */
        template<typename CPU>
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType128 
         */
        template<typename CPU>
        ...
        /**
         * @tparam CPU 
         * @return CPU::ValueWithShadowType256 
         */
        template<typename CPU>
    ...
    private:
        /**
         * @brief Construct a new Memory Or Register Reference object
         * 
         */
    ...
    public:
        ...
        ALWAYS_INLINE InstructionHandler handler() const 
        { 
            return m_descriptor->handler; 
        }

        bool has_segment_prefix() const 
        { 
            return m_segment_prefix != 0xff; 
        }
        ...
        bool has_address_size_override_prefix() const 
        { 
            return m_has_address_size_override_prefix; 
        }

        bool has_operand_size_override_prefix() const 
        { 
            return m_has_operand_size_override_prefix; 
        }

        bool has_lock_prefix() const 
        { 
            return m_has_lock_prefix; 
        }
        ...
        { 
            return m_a32 ? imm32() : imm16(); 
        }

        LogicalAddress imm_address16_16() const 
        { 
            return LogicalAddress(imm16_1(), imm16_2()); 
        }

        LogicalAddress imm_address16_32() const 
        { 
            return LogicalAddress(imm16_1(), imm32_2()); 
        }
        ...
        SegmentRegister segment_register() const 
        { 
            return static_cast<SegmentRegister>(register_index()); 
        }

        u8 cc() const 
        { 
            return has_sub_op() ? m_sub_op & 0xf : m_op & 0xf; 
        }
        ...
        , m_o32(o32)
    {
        ...
        if (!m_descriptor->mnemonic) {
            if (has_sub_op()) {
                if (has_slash)
                    warnln("{:02X} {:02X} /{} not understood", m_op, m_sub_op, slash());
                else
                    warnln("{:02X} {:02X} not understood", m_op, m_sub_op);
            } else {
                if (has_slash)
                    warnln("{:02X} /{} not understood", m_op, slash());
                else
                    warnln("{:02X} not understood", m_op);
            }
