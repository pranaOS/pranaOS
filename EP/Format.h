...
#include <EP/CheckedFormatString.h>

#include <EP/AllOf.h>
#include <EP/AnyOf.h>
#include <EP/Array.h>
#include <EP/GenericLexer.h>
...
using EP::CheckedFormatString;
using EP::FormatIfSupported;
using EP::FormatString;
