...
#include <EP/StringHash.h>
#include <EP/StringUtils.h>
#include <EP/Vector.h>
...
[[nodiscard]] ALWAYS_INLINE constexpr EP::StringView operator"" sv(const char* cstring, size_t length)
{
    return EP::StringView(cstring, length);
}
