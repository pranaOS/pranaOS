...
{
    {
        URL url("https://krishpranav.github.io");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.protocol(), "http");
        EXPECT_EQ(url.host(), "https://krishpranav.github.io");
    ...
    }
    {
        ...
        EXPECT_EQ(url.host(), "www.krishpranav.github.io.org");
    ...
    {
        URL url("https://krishpranav.github.io/index.html?#");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.protocol(), "http");
        EXPECT_EQ(url.host(), "krishpranav.github.io");
        EXPECT_EQ(url.port(), 80);
        EXPECT_EQ(url.path(), "/index.html");
        EXPECT_EQ(url.query(), "");
        EXPECT_EQ(url.fragment(), "");
    ...
    {
        URL url("https://krishpranav.github.io/index.html?foo=1&bar=2");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.protocol(), "http");
        EXPECT_EQ(url.host(), "krishpranav.github.io");
        EXPECT_EQ(url.port(), 80);
    ...
    {
        URL url("https://krishpranav.github.io/index.html#fragment");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.protocol(), "http");
        EXPECT_EQ(url.host(), "krishpranav.github.io");
        EXPECT_EQ(url.port(), 80);
    ...
    {
        URL url("https://krishpranav.github.io/index.html?foo=1&bar=2&baz=/?#frag/ment?test#");
        EXPECT_EQ(url.is_valid(), true);
        EXPECT_EQ(url.protocol(), "http");
        EXPECT_EQ(url.host(), "krishpranav.github.io");
        EXPECT_EQ(url.port(), 80);
...
{
    EXPECT_EQ(URL("https://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("://krishpranav.github.io").is_valid(), false);
    EXPECT_EQ(URL("://:80").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:80:80/").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:80:80").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:abc").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:abc:80").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:abc:80/").is_valid(), false);
    EXPECT_EQ(URL("https://krishpranav.github.io:/abc/").is_valid(), false);
...
{
    EXPECT_EQ(URL("https://krishpranav.github.io/").to_string(), "https://krishpranav.github.io/");
    EXPECT_EQ(URL("https://krishpranav.github.io:0/").to_string(), "https://krishpranav.github.io/");
    EXPECT_EQ(URL("https://krishpranav.github.io:80/").to_string(), "https://krishpranav.github.io/");
    EXPECT_EQ(URL("https://krishpranav.github.io:81/").to_string(), "https://krishpranav.github.io:81/");
    EXPECT_EQ(URL("https://krishpranav.github.io:443/foo/bar.html?query#fragment").to_string(), "https://krishpranav.github.io/foo/bar.html?query#fragment");
}
