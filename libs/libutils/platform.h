...
#ifdef __x86_64__
#    define UTILS_ARCH_X86_64 1
#endif

#if defined(__APPLE__) && defined(__MACH__)
#    define UTILS_OS_MACOS
#    define UTILS_OS_BSD_GENERIC
#endif
...
#define ARCH(arch) (defined(UTILS_ARCH_##arch) && UTILS_ARCH_##arch)

#if !defined(__clang__)
#    define UTILS_HAS_CONDITIONALLY_TRIVIAL
#endif
