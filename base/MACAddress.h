...
public:
    ...
    static Optional<MACAddress> from_string(const StringView& string)
    {
        ...
        auto a = Base::StringUtils::convert_to_uint_from_hex(parts[0]).value_or(256);
        auto b = Base::StringUtils::convert_to_uint_from_hex(parts[1]).value_or(256);
        auto c = Base::StringUtils::convert_to_uint_from_hex(parts[2]).value_or(256);
        auto d = Base::StringUtils::convert_to_uint_from_hex(parts[3]).value_or(256);
        auto e = Base::StringUtils::convert_to_uint_from_hex(parts[4]).value_or(256);
        auto f = Base::StringUtils::convert_to_uint_from_hex(parts[5]).value_or(256);
