...
#define IMM_UINT_MAX (1ull << (64 - 2 - 1 ))
#define IMM_UINT_MIN (0)
#define IMM_SINT_MAX ((s64)IMM_UINT_MAX)
#define IMM_SINT_MIN (((s64)(1ull << 63)) >> 2) 
...
#define DIV(__x, __by, __q, __r)                                                     \
    do                                                                               \
    {                                                                                \
        asm("udiv %0, %1, %2" : "=r"(__q) : "r"(__x), "r"((u64)__by));               \
        asm("msub %0, %2, %3, %1" : "=r"(__r) : "r"(__x), "r"(__q), "r"((u64)__by)); \
    } while(0)
...
#define USER_LIMIT 0x0001000000000000ull 
