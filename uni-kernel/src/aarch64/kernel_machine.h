/**
 * @file kernel_machine.h
 * @author Krisna Pranav
 * @brief kernel machine
 * @version 6.0
 * @date 2025-03-29
 *
...
#define KERNEL_PHYS 0x0000000040400000ull 
...
#define ESR_ISS_INST_ABRT_SET_UER 0    
#define ESR_ISS_INST_ABRT_SET_UC 2     
#define ESR_ISS_INST_ABRT_SET_UEO_CE 0 

#define ESR_ISS_DATA_ABRT_ISV U64_FROM_BIT(24) 
#define ESR_ISS_DATA_ABRT_SAS_BITS 2           
#define ESR_ISS_DATA_ABRT_SAS_SHIFT 22
#define ESR_ISS_DATA_ABRT_SSE U64_FROM_BIT(21) 
#define ESR_ISS_DATA_ABRT_SRT_BITS 5           
#define ESR_ISS_DATA_ABRT_SRT_SHIFT 16
#define ESR_ISS_DATA_ABRT_SF U64_FROM_BIT(15) 

#define ESR_ISS_DATA_ABRT_FnV U64_FROM_BIT(10) 
#define ESR_ISS_DATA_ABRT_CM U64_FROM_BIT(8)   
#define ESR_ISS_DATA_ABRT_WnR U64_FROM_BIT(6)  
...
#define ID_AA64ISAR0_EL1_RNDR_IMPLEMENTED 1 
...
#define SCTLR_EL1_UCI U64_FROM_BIT(26)    
#define SCTLR_EL1_EE U64_FROM_BIT(25)     
#define SCTLR_EL1_E0E U64_FROM_BIT(24)    
#define SCTLR_EL1_SPAN U64_FROM_BIT(23)   
#define SCTLR_EL1_EIS U64_FROM_BIT(22)    
#define SCTLR_EL1_WXN U64_FROM_BIT(19)    
#define SCTLR_EL1_nTWE U64_FROM_BIT(18)   
#define SCTLR_EL1_nTWI U64_FROM_BIT(16)   
#define SCTLR_EL1_UCT U64_FROM_BIT(15)    
#define SCTLR_EL1_I U64_FROM_BIT(12)      
#define SCTLR_EL1_CP15BEN U64_FROM_BIT(5) 
#define SCTLR_EL1_SA0 U64_FROM_BIT(4)     
#define SCTLR_EL1_SA U64_FROM_BIT(3)      
#define SCTLR_EL1_C U64_FROM_BIT(2)       
#define SCTLR_EL1_A U64_FROM_BIT(1)       
#define SCTLR_EL1_M U64_FROM_BIT(0)       

#define SPSR_I U64_FROM_BIT(7)
#define SPSR_SS U64_FROM_BIT(21)
#define SPSR_TCO U64_FROM_BIT(25)

#define MDSCR_EL1_SS U64_FROM_BIT(0) 

#define CNTKCTL_EL1_EL0VCTEN U64_FROM_BIT(1) 
...
#define write_psr(reg, v)                                   \
    do                                                      \
    {                                                       \
        asm volatile("msr " #reg ", %0" : : "r"((u64)(v))); \
    } while(0)
#define read_psr_s(rstr) ({ register u64 r; asm volatile("mrs %0, " rstr : "=r"(r)); r; })
#define write_psr_s(rstr, v)                                \
    do                                                      \
    {                                                       \
        asm volatile("msr " rstr ", %0" : : "r"((u64)(v))); \
    } while(0)
...
/**
 * @brief Get the frame ra ptr object
 * 
 * @param fp 
 * @param nfp 
 * @return u64* 
...
#define switch_stack(s, target)    \
    _switch_stack_head(s, target); \
    _switch_stack_tail()
#define switch_stack_1(s, target, __a0) \
    do                                  \
    {                                   \
        _switch_stack_head(s, target);  \
        _switch_stack_args_1(__a0);     \
        _switch_stack_tail("r"(__ra0)); \
    } while(0)
#define switch_stack_2(s, target, __a0, __a1)       \
    do                                              \
    {                                               \
        _switch_stack_head(s, target);              \
        _switch_stack_args_2(__a0, __a1);           \
        _switch_stack_tail("r"(__ra0), "r"(__ra1)); \
    } while(0)
#define switch_stack_3(s, target, __a0, __a1, __a2)             \
    do                                                          \
    {                                                           \
        _switch_stack_head(s, target);                          \
        _switch_stack_args_3(__a0, __a1, __a2);                 \
        _switch_stack_tail("r"(__ra0), "r"(__ra1), "r"(__ra2)); \
    } while(0)
#define switch_stack_4(s, target, __a0, __a1, __a2, __a3)                   \
    do                                                                      \
    {                                                                       \
        _switch_stack_head(s, target);                                      \
        _switch_stack_args_4(__a0, __a1, __a2, __a3);                       \
        _switch_stack_tail("r"(__ra0), "r"(__ra1), "r"(__ra2), "r"(__ra3)); \
    } while(0)
#define switch_stack_5(s, target, __a0, __a1, __a2, __a3, __a4)                         \
    do                                                                                  \
    {                                                                                   \
        _switch_stack_head(s, target);                                                  \
        _switch_stack_args_5(__a0, __a1, __a2, __a3, __a4);                             \
        _switch_stack_tail("r"(__ra0), "r"(__ra1), "r"(__ra2), "r"(__ra3), "r"(__ra4)); \
    } while(0)
