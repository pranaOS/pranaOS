...
namespace Debug 
{
    ...
    /**
     * @brief Construct a new DebugInfo::DebugInfo object
     * 
     * @param elf 
     * @param source_root 
     * @param base_address 
    ...
    void DebugInfo::prepare_lines()
    {
        ...
        auto compute_full_path = [&](FlyString const& file_path) -> Optional<String> {
            ...
            if (auto index_of_pranaos_slash = file_path.view().find("pranaos/"sv); index_of_pranaos_slash.has_value()) {
                auto start_index = index_of_pranaos_slash.value() + "pranaos/"sv.length();
    ...
    Optional<DebugInfo::SourcePositionAndAddress> DebugInfo::get_address_from_source_position(String const& file, size_t line) const
    {
        ...
        if (file.starts_with(PRANAOS_LIBS_PREFIX)) {
            file_path = file.substring(sizeof(PRANAOS_LIBS_PREFIX), file.length() - sizeof(PRANAOS_LIBS_PREFIX));
            file_path = String::formatted("../{}", file_path);
        }
    ...
    /**
     * @param regs 
     * @return NonnullOwnPtrVector<DebugInfo::VariableInfo> 
     */
    ...
    /**
     * @param address 
     * @return Optional<DebugInfo::VariablesScope> 
     */
    ...
    /**
     * @param scope 
     * @return Vector<DebugInfo::SourcePosition> 
     */
    ...
    /**
     * @param line 
     * @return DebugInfo::SourcePosition 
     */
    ...
    /**
     * @param address 
     * @return DebugInfo::SourcePositionWithInlines 
     */
