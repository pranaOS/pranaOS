...
namespace EDID 
{
    ...
    public:
        ...
        /**
         * @param callback 
         * @return ErrorOr<IterationDecision> 
         */
    ...
    private:
        /**
         * @brief Construct a new CEA861ExtensionBlock object
         * 
         * @param edid 
         * @param block 
         */
        ...
        const
    {
        ...
        return Mods::convert_between_host_and_little_endian(read_host(field));
    }
    ...
    {
        static_assert(sizeof(T) > 1);
        return Mods::convert_between_host_and_big_endian(read_host(field));
    }

    /**
     * @param bytes 
     * @return ErrorOr<Parser> 
     */
    ...
    /**
     * @param index 
     * @return Optional<DetailedTiming> 
     */
    ...
    /**
     * @return ErrorOr<Vector<SupportedResolution>> 
     */
