...
namespace Crypto::ASN1 
{
    ...
    /**
     * @param data 
     * @return Result<BitStringView, DecodeError> 
     */
 ...
 * @return ErrorOr<void> 
 */
ErrorOr<void> Mods::Formatter<Crypto::ASN1::DecodeError>::format(FormatBuilder& fmtbuilder, Crypto::ASN1::DecodeError error)
{
