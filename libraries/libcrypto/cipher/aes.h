...
namespace Crypto 
{
    namespace Cipher 
    {
        ...
        public:
             ...
             * @return ByteBuffer 
             */
            virtual ByteBuffer get() const override 
            { 
                return m_data; 
            };

            /**
             * @return const ByteBuffer& 
             */
            virtual const ByteBuffer& data() const override 
            { 
                return m_data; 
            };
             ...
             * @param buffer 
             */
            virtual void overwrite(const ByteBuffer& buffer) override 
            { 
             ...
             * @param size 
             */
            virtual void overwrite(const u8* data, size_t size) override 
            { 
                overwrite({ data, size }); 
            }
        ...
        private:
            virtual ByteBuffer& data() override 
            { 
                return m_data; 
            };

            ByteBuffer m_data;
        }; // struct AESCipherBlock
        ...
        struct AESCipherKey : public CipherKey 
        {
             ...
             * @return ByteBuffer 
             */
            virtual ByteBuffer data() const override 
            { 
                return ByteBuffer::copy(m_rd_keys, sizeof(m_rd_keys)); 
            };
        ...
        public:
            ...
            /**
             * @return const AESCipherKey& 
             */
            virtual const AESCipherKey& key() const override 
            { 
                return m_key; 
            };
