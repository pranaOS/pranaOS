...
class SpinLock {
    BASE_MAKE_NONCOPYABLE(SpinLock);
    BASE_MAKE_NONMOVABLE(SpinLock);
...
class RecursiveSpinLock {
    BASE_MAKE_NONCOPYABLE(RecursiveSpinLock);
    BASE_MAKE_NONMOVABLE(RecursiveSpinLock);
...
class [[nodiscard]] ScopedSpinLock {
    ...
    BASE_MAKE_NONCOPYABLE(ScopedSpinLock);
