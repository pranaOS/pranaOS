...
KERNEL_LIBRARIES_SOURCES = \
	...
	$(wildcard userspace/libraries/libc/pranaos/NumberFormatter.cpp) \
	$(wildcard userspace/libraries/libc/pranaos/Printf.cpp) \
	$(wildcard userspace/libraries/libc/pranaos/Time.cpp) \
