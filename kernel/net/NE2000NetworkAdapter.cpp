...
UNMAP_AFTER_INIT RefPtr<NE2000NetworkAdapter> NE2000NetworkAdapter::try_to_initialize(PCI::Address address)
{
    constexpr auto ne2k_ids = Array {
        PCI::ID { 0x10EC, 0x8029 }, 

        PCI::ID { 0x1050, 0x0940 }, 
        PCI::ID { 0x11f6, 0x1401 }, 
        PCI::ID { 0x8e2e, 0x3000 }, 
        PCI::ID { 0x4a14, 0x5000 }, 
        PCI::ID { 0x1106, 0x0926 }, 
        PCI::ID { 0x10bd, 0x0e34 }, 
        PCI::ID { 0x1050, 0x5a5a }, 
        PCI::ID { 0x12c3, 0x0058 },  
        PCI::ID { 0x12c3, 0x5598 },  
        PCI::ID { 0x8c4a, 0x1980 }, 
    };
